...
export default function UserProfilePage() {
    ...
    return (
        <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-fade-in">
            ...
            {/* Profile Tabs */}
            <div className="flex items-center gap-6 mt-8 border-b border-atlas-border">
                <Link href={`/u/${lowerUsername}`} className="pb-3 border-b-2 border-atlas-blue text-atlas-text-primary font-medium text-sm">
                    Overview
                </Link>
                <Link href={`/u/${lowerUsername}/collections`} className="pb-3 border-b-2 border-transparent text-atlas-text-muted hover:text-atlas-text-primary text-sm transition-colors">
                    Collections
                </Link>
            </div>
